 ...
 <div class="mdk-box mdk-box--bg-primary bg-dark js-mdk-box mb-0"
                    ...
                    <!-- <div class="mdk-box__bg">
                        <div class="mdk-box__bg-front"
                             style="background-image: url(<?= media() ?>/images/photodune-4161018-group-of-students-m.jpg);"></div>
                    </div> -->
                    <div class="mdk-box__content justify-content-center row card-group-row mb-16pt mb-lg-40pt">
                        ...
                        <div class="hero container page__container py-112pt col-lg-4 col-sm-6">
                            <img class="img_estudent" src="<?= media() ?>/images/estudent.png" alt="">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row card-group-row">
                            ...
                            <div class="col-md-6 col-lg-4 card-group-row__col">
                                ...
                                <div class="card card--elevated posts-card-popular overlay card-group-row__card">
                                    <img src="<?= media() ?>/images/paths/sketch_430x168.png"
                                         alt=""
                                         class="card-img">
                                        ...
                                        <div class="card-body d-flex align-items-center">
                                            <div class="avatar-group flex">
                                                <div class="avatar avatar-xs"
                                                     ...
                                                     data-placement="top"
                                                     title="Janell D.">
                                                    <a href=""><img src="<?= media() ?>/images/256_luke-porter-261779-unsplash.jpg"
                                                             alt="Avatar"
                            ...
                            <div class="col-md-6 col-lg-4 card-group-row__col">
                                ...
                                <div class="card card--elevated posts-card-popular overlay card-group-row__card">
                                    <img src="<?= media() ?>/images/paths/invision_430x168.png"
                                         alt=""
                                         class="card-img">
                                    <div class="fullbleed bg-primary"
                                         style="opacity: .5"></div>
                                        ...
                                        <div class="card-body d-flex align-items-center">
                                            <div class="avatar-group flex">
                                                <div class="avatar avatar-xs"
                                                     ...
                                                     data-placement="top"
                                                     title="Janell D.">
                                                    <a href=""><img src="<?= media() ?>/images/256_michael-dam-258165-unsplash.jpg"
                                                             alt="Avatar"
                                                             class="avatar-img rounded-circle"></a>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 card-group-row__col">
                                ...
                                <div class="card card--elevated posts-card-popular overlay card-group-row__card">
                                    <img src="<?= media() ?>/images/paths/photoshop_430x168.png"
                                         alt=""
                                         class="card-img">
                                    <div class="fullbleed bg-primary"
                                         style="opacity: .5"></div>
                                        ...
                                        <div class="card-body d-flex align-items-center">
                                            <div class="avatar-group flex">
                                                <div class="avatar avatar-xs"
                                                     ...
                                                     data-placement="top"
                                                     title="Janell D.">
                                                    <a href=""><img src="<?= media() ?>/images/256_rsz_1andy-lee-642320-unsplash.jpg"
                                                             alt="Avatar"
                                                             class="avatar-img rounded-circle"></a>
                                                </div>
                                            </div>
                            ...
                            <div class="card posts-card mb-0">
                                <div class="posts-card__content d-flex align-items-center flex-wrap">
                                    <div class="avatar avatar-lg mr-3">
                                        <a href="blog-post.html"><img src="<?= media() ?>/images/paths/invision_200x168.png"
                                                 alt="avatar"
                                        ...
                                        <div class="media ml-sm-auto align-items-center">
                                            <div class="media-left mr-2 avatar-group">
                                                ...
                                                <div class="avatar avatar-xs"
                                                     ...
                                                     data-placement="top"
                                                     title="Janell D.">
                                                    <img src="<?= media() ?>/images/256_rsz_1andy-lee-642320-unsplash.jpg"
                                                         alt="Avatar"
                                                ...
                                                <div class="avatar avatar-xs"
                                                     ...
                                                     data-placement="top"
                                                     title="Janell D.">
                                                    <img src="<?= media() ?>/images/256_michael-dam-258165-unsplash.jpg"
                                                         alt="Avatar"
                                                         class="avatar-img rounded-circle">
                                                </div>
                                                ...
                                                <div class="avatar avatar-xs"
                                                     ...
                                                     data-placement="top"
                                                     title="Janell D.">
                                                    <img src="<?= media() ?>/images/256_luke-porter-261779-unsplash.jpg"
                                                         alt="Avatar"
                                                         class="avatar-img rounded-circle">
                                                </div>
                                            ...
                                            <div class="flex">
                                                <div class="d-flex align-items-center">
                                                    <div class="rounded mr-12pt z-0 o-hidden">
                                                        <div class="overlay">
                                                            <img src="<?= media() ?>/images/paths/react_40x40@2x.png"
                                                                 width="40"
                                                                 height="40"
                                                                 alt="Angular"
                                                                 class="rounded">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex">
                                                <div class="d-flex align-items-center">
                                                    <div class="rounded mr-12pt z-0 o-hidden">
                                                        <div class="overlay">
                                                            <img src="<?= media() ?>/images/paths/devops_40x40@2x.png"
                                                                 width="40"
                                                                 height="40"
                                                                 alt="Angular"
                                                                 class="rounded">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex">
                                                <div class="d-flex align-items-center">
                                                    <div class="rounded mr-12pt z-0 o-hidden">
                                                        <div class="overlay">
                                                            <img src="<?= media() ?>/images/paths/redis_40x40@2x.png"
                                                                 width="40"
                                                                 height="40"
                                                                 alt="Angular"
                                                                 class="rounded">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex">
                                                <div class="d-flex align-items-center">
                                                    <div class="rounded mr-12pt z-0 o-hidden">
                                                        <div class="overlay">
                                                            <img src="<?= media() ?>/images/paths/mailchimp_40x40@2x.png"
                                                                 width="40"
                                                                 height="40"
                                                                 alt="Angular"
                                                                 class="rounded">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex">
                                                <div class="d-flex align-items-center">
                                                    <div class="rounded mr-12pt z-0 o-hidden">
                                                        <div class="overlay">
                                                            <img src="<?= media() ?>/images/paths/swift_40x40@2x.png"
                                                                 width="40"
                                                                 height="40"
                                                                 alt="Angular"
                                                                 class="rounded">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex">
                                                <div class="d-flex align-items-center">
                                                    <div class="rounded mr-12pt z-0 o-hidden">
                                                        <div class="overlay">
                                                            <img src="<?= media() ?>/images/paths/wordpress_40x40@2x.png"
                                                                 width="40"
                                                                 height="40"
                                                                 alt="Angular"
                                                                 class="rounded">
                        ...
                        <div class="row card-group-row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
                                ...
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        <div class="media-left mr-12pt">
                                            <img src="<?= media() ?>/images/paths/sketch_40x40@2x.png"
                                                 width="40"
                                                 height="40"
                                                 alt="Angular"
                                                 class="rounded">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
                                ...
                                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay card-group-row__card"
                                    ...
                                    <a href="student-course.html"
                                       ...
                                       data-position=""
                                       data-height="140">
                                        <img src="<?= media() ?>/images/paths/flinto_430x168.png"
                                             alt="course">
                                        <span class="overlay__content">
                                            <span class="overlay__action d-flex flex-column text-center">
                                                <i class="material-icons icon-32pt">play_circle_outline</i>
                                ...
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        <div class="media-left mr-12pt">
                                            <img src="<?= media() ?>/images/paths/flinto_40x40@2x.png"
                                                 width="40"
                                                 height="40"
                                                 alt="Angular"
                                                 class="rounded">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
                                ...
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        <div class="media-left mr-12pt">
                                            <img src="<?= media() ?>/images/paths/photoshop_40x40@2x.png"
                                                 width="40"
                                                 height="40"
                                                 alt="Angular"
                                                 class="rounded">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
                                ...
                                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay card-group-row__card"
                                    ...
                                    <a href="student-course.html"
                                       ...
                                       data-position=""
                                       data-height="140">
                                        <img src="<?= media() ?>/images/paths/figma_430x168.png"
                                             alt="course">
                                        <span class="overlay__content">
                                            <span class="overlay__action d-flex flex-column text-center">
                                                <i class="material-icons icon-32pt">play_circle_outline</i>
                                ...
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        <div class="media-left mr-12pt">
                                            <img src="<?= media() ?>/images/paths/figma_40x40@2x.png"
                                                 width="40"
                                                 height="40"
                                                 alt="Angular"
                                                 class="rounded">
                                            ...
                                            <div class="media-left mr-12pt">
                                                <a href="student-profile.html"
                                                   class="avatar avatar-sm">
                                                    <!-- <img src="<?= media() ?>/images/people/110/guy-.jpg" width="40" alt="avatar" class="rounded-circle"> -->
